...
public class MybatisCodeGenerator {
    ...
    static {
        // 必填
        ds.setUrl("jdbc:mysql://localhost:3306/" + schemaName + "?characterEncoding=utf8&useSSL=false&serverTimezone=UTC&rewriteBatchedStatements=true&allowPublicKeyRetrieval=true");
        ds.setUsername("root");
